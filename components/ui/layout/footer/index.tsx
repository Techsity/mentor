			...
			<div className="mx-auto w-full max-w-screen-2xl">
				<div className="grid grid-cols-2 gap-8 px-4 py-8 lg:py-20 md:grid-cols-4 xl:grid-cols-5 md:px-20 xl:px-40">
					...
					<div>
						...
						<ul className="text-white" style={{ fontWeight: "300" }}>
							<Link href="#">
								<li className="mb-4 cursor-pointer text-[14px]">Technical Courses</li>
							</Link>
							<Link href="#">
								<li className="mb-4 cursor-pointer text-[14px]">Vocational Courses</li>
							</Link>
							<Link href="#">
								<li className="mb-4 cursor-pointer text-[14px]">Educational Courses</li>
							</Link>
						</ul>
					</div>
					<div>
