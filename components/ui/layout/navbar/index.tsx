      ...
      {!hideNavSections ? (
        <div className="hidden md:flex justify-between gap-6 items-center text-[#094B10]">
          ...
          <Link href={"/mentor/onboarding"}>
            <div className="whitespace-nowrap text-sm border-[#094B10] select-none cursor-pointer font-[500] border-l-[.15em] border-r-[.15em] p-4 border-opacity-65 hover:text-white hover:bg-[#094B10] hover:rounded duration-300 h-5 flex items-center justify-center">
              Become a Mentor
            </div>
          </Link>
        </div>
