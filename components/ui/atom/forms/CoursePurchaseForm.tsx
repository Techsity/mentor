...
const CoursePurchaseForm = () => {
	...
	return (
		<>
			<div className="flex items-center lg:px-28 sm:px-12 px-6 py-20">
				<div className="">
					<h1
					...
					<div className="grid gap-3">
						...
						<div className="">
							...
							<div className="grid gap-3">
								...
								<div className="grid gap-3">
									{paymentMethods.map(({ img, name }, i) => (
										<span
											onClick={() =>
												setSelectedMethod(name)
											}
											className="border border-[#70C5A1] p-6 flex justify-between items-center cursor-pointer"
											key={i}>
