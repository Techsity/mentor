		...
		<div className="rounded-lg relative p-[1.4px] group overflow-hidden">
			...
			<div className="flex flex-col gap-20 p-5 bg-white rounded z-10 relative">
				<p className="lg:max-w-[16em] text-sm">
					With Mentör, ive been able to get better at my skills. With Mentör, ive
					been able to get better at my skills.With Mentör, ive been able to get
					better at my skills.With Mentör, ive been able to get better at my skills.
				</p>
				<div className="flex items-center justify-between">
					<p>{fullName}</p>
					<img
						src={avatarUrl ? avatarUrl : "/assets/images/avatar.png"}
