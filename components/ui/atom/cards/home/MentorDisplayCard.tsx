...
const MentorDisplayCard = ({ mentor }: { mentor: IMentor }) => {
	return (
		<div className="bg-white relative w-[330px] rounded md:w-[345px] h-[395px] sm:h-[380px] lg:w-[300px] tracking-tight duration-300 group hover:shadow-lg overflow-hidden cursor-default">
			...
			<div className="flex sm:justify-center sm:p-0 pl-5">
				<div className="grid py-6 sm:py-10 px-5 gap-2">
					...
					<h1 className="text-xl mt-6 font-medium capitalize">{mentor.name}</h1>
