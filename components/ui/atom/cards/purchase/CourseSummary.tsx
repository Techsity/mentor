		...
		<>
			<div className="sticky h-full py-3 xl:py-8 2xl:py-12 gap-4 w-full bottom-0 text-white bg-[#70C5A1] grid sm:grid-cols-2 items-center lg:px-20 sm:px-12 px-6">
				<div className="grid gap-2">
					...
					<h1 className="md:text-2xl 2xl:text-4xl font-thin" style={{ fontFamily: "Days One" }}>
						{course.title}
					</h1>
					<div className="flex items-center max-w-sm justify-between gap-4 font-[300] text-sm 2xl:text-xl 2xl:max-w-lg">
						...
						{/* <p className="">{formatFollowersCount(course.reviews.length)} reviews</p> */}
				...
				<div className="flex md:justify-end">
					<div className="my-2 sm:my-4 flex items-center gap-2">
						...
						<div className="grid items-center max-w-sm font-[300] text-sm gap-1">
							...
							<p className="">{course.mentor.role.split("_").join(" ")} </p>
