...
const DisplayCourseCard = ({ course }: { course: ICourse }) => {
    ...
    <>
      <div className="inline-block snap-start">
        <div className="w-auto h-auto md:h-[465px] lg:h-[430px] md:max-w-md xl:max-w-lg relative overflow-hidden shadow pb-4 bg-white hover:shadow-xl transition-shadow duration-300 ease-in-out">
          <>
