...
const EditCourseContent = (props: { content?: ICourseContent[] }) => {
	...
	const [state, setState] = useState<ICourseContent[]>(props.content || [initialState]);
...
const ContentEditComponent: FC<ICourseContent> = ({ course_sections, title }) => {
		...
		<div className="">
			...
			<div className="">
				<div className="my-4 flex justify-between items-center max-w-2xl">
					...
					<div className="cursor-pointer text-[#70C5A1] select-none">+ Add New Lecture</div>
				</div>
