...
const CourseContents = ({
	...
	return inProgress ? (
		...
		<div
			className={classNames(
				"lg:max-w-[38%] w-full bg-[#fff] sm:p-8 p-4 text-black xl:-mt-24 border-2 border-[#70C5A1] lg:sticky top-24 overflow-y-auto animate__animated animate__fadeIn",
				className,
			)}>
			...
			<div className="my-6 grid gap-4 overflow-hidden">
				...
				<PrimaryButton
					...
					link={isSubscribed ? `/courses/${course?.id}/learn` : `/courses/${course?.id}/purchase`}
...
const CourseContentItem = ({
	...
	activeContent: ICourseContent | null;
