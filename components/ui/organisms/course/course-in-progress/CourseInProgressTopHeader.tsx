			...
			<div className="flex-grow overflow-hidden animate__animated animate__slideInLeft inline-flex flex-col gap-3">
				...
				<div className="grid gap-2">
					...
					<div className="flex items-center max-w-sm justify-between gap-4 font-[300] text-sm 2xl:text-xl 2xl:max-w-lg">
						<p className="text-xs">{course.course_level}</p>
						<p className="text-xs">{course.duration} hours</p>
						<p className="text-xs">{course.reviews && course.reviews.length} reviews</p>
				...
				<div className="my-2 sm:my-4 flex items-center gap-2 overflow-hidden">
					...
					<div className="grid items-center max-w-sm font-[300] text-sm gap-1">
						...
						<p className="text-xs capitalize">
							{course.mentor.role.toString().split("_").join(" ").toLowerCase()}{" "}
						</p>
