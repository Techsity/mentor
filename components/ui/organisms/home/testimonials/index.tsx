	...
	return (
		<div
			...
			<div className="lg:hidden grid gap-6 py-10 flex-grow">
				<p className="text-[#33AC15] max-w-md  text-2xl" style={{ fontFamily: "Days One" }}>
					Over +500k Students Gave us their Thumbs Up
				</p>
				<p className="text-sm max-w-md">
					In case you&apos;re in any doubt, check out the reviews of over 500k students about how we&apos;ve
			...
			<AnimationOnScroll animateIn="animate__fadeInUp" animateOnce={true}>
				<div className="hidden lg:grid gap-6 py-10 flex-grow order-1">
					...
					<p className="text-sm max-w-md">
						In case you&apos;re in any doubt, check out the reviews of over 500k students about how
						we&apos;ve help and turn their life around
					</p>
