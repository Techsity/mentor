        ...
        <div className="grid items-center py-20">
          ...
          <div className="grid mt-6 text-xs sm:text-sm gap-4 mt-2 text-[#ddd]">
            <div className="flex gap-1 items-center">
              ...
              <p>
                Join millions of students benefiting from our free courses and
                events.
              </p>
            </div>
            ...
            <div className="flex gap-1 items-center animate__slideInLeft animate__slower">
              <CheckmarkSharp color="#0CF27E" width="15px" height="15px" />
              <p>
                Enjoy free live workshop tailored to your interest. Interact
            ...
            <div className="flex gap-1 items-center animate__slideInLeft animate__slowest">
              <CheckmarkSharp color="#0CF27E" width="15px" height="15px" />
              <p>
                Access over 100,000 mentors eager to connect with you through a
                call.
              </p>
            </div>
          </div>
