...
const MenteeDashboardHero = ({ categories, loading }: { categories: ICourseCategory[]; loading: boolean }) => {
	const fetchCourses = () => {
		// Query to fetch courses bsed on category
	};
	return (
							...
							<>
								...
								<div className="flex flex-wrap gap-3 items-center max-w-lg sm:max-w-xl my-4">
									{categories
										.map((category) => (
											<>
												<div className="bg-[#70C5A1] flex gap-5 items-center text-center p-1.5 duration-300 cursor-pointer hover:bg-[#4F8E74] px-4 rounded-full">
