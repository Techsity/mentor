...
<<<<<<< HEAD
  ...
  const [state, setState] = React.useState<PropState>({
    categories: [],
    loading: true,
  });
  ...
  const [fetchCategories] = useLazyQuery<
    { getAllCategories: ICourseCategory[] },
    any
  >(GET_ALL_CATEGORIES, {
...
>>>>>>> 11679716f01c7a44b39f1b67a6355b24a5ab5a14
  ...
  return (
    <div className="md:h-[75vh] md:px-20 px-10 pt-20 bg-[#0C202B] relative overflow-hidden">
      ...
      <div className="flex justify-center lg:justify-between items-start sm:mt-28 relative z-30 text-white">
        <div className="">
          <h1
            className="md:text-4xl text-2xl px-3"
