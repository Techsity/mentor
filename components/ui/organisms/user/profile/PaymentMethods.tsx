	...
	return (
		<div className="flex flex-col xl:flex-row gap-6 2xl:gap-10 justify-between items-start animate__animated animate__fadeInUp overflow-hidden pb-20">
			<div className="md:max-w-[45%] w-full">
				<div className="flex tracking-tight justify-center items-center select-none gap-2">
					{tabs?.map((tab, i) => {
						return (
							<div
								key={i}
								className={`capitalize text-sm duration-300 border border-[#094B10] text-[#094B10] px-5 sm:px-8 p-3 cursor-pointer w-full ${
									activeTab === tab
