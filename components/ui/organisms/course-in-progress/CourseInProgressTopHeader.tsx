...
const CourseInProgressTopHeader = (course: ICourse) => {
	return (
		<>
			<div className="w-full flex md:flex-row flex-col gap-5 justify-between relative pt-16">
				<div className="flex-grow overflow-hidden animate__animated animate__slideInLeft inline-flex flex-col gap-3">
				...
				<div className="w-auto h-auto lg:max-w-lg 2xl:max-w-2xl sm:max-w-md hidden sm:block">
