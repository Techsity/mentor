	...
	return (
		<>
			...
			<div className="flex flex-col xl:gap-6 xl:flex-row item-start w-full h-full min-w-screen">
				<div className="xs:px-12 lg:px-0 lg:pl-12 pt-10 sticky z-10 top-11 md:top-[9dvh] xl:top-20 w-full max-w-xs h-[50%]">
				...
				<div className="flex-grow py-10 xl:order-none order-last min-h-screen w-full">
					<ProfileComponents activeTab={activeTab} />
				</div>
				<div className="xl:sticky top-20 bg-[#F6F9F8] p-4 w-full max-w-xs min-h-[90dvh] h-full mx-3 xs:mx-12 lg:mx-0">
